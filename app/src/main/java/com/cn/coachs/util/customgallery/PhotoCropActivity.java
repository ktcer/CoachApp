...
import com.cn.coachs.util.CropImageView;
...
public class PhotoCropActivity extends PhotoBaseActivity implements View.OnClickListener {
    ...
    private BeanPhotoInfo mPhotoInfo;
    ...
    @Override
    protected void takeResult(BeanPhotoInfo info) {
        mPhotoInfo = info;
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.fab_ok) {
            ...
            try {
                new File(AppDisk.PICTUREPOLDER, ".nomedia").createNewFile();
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            try {
                File toFile = new File(AppDisk.PICTUREPOLDER, "IMG" + DateUtils.format(new Date(), "yyyyMMddHHmmss") + ".jpg");
