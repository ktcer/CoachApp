...
package com.cn.coachs.util.customgallery.adapter;
 ...
 */
public class FolderListAdapter extends CommonBaseAdapter<FolderListAdapter.FolderViewHolder, BeanPhotoFolderInfo> {

    private BeanPhotoFolderInfo mSelectFolder;

    public FolderListAdapter(Context context, List<BeanPhotoFolderInfo> list) {
        super(context, list);
    }
    ...
    public void onBindViewHolder(FolderViewHolder holder, int position) {
        BeanPhotoFolderInfo photoFolderInfo = mList.get(position);
        ...
        path = "file:/" + path;
        holder.mIvCover.setImageResource(R.drawable.default_pic);
        ...
        if (mSelectFolder == photoFolderInfo || (mSelectFolder == null && position == 0)) {
            ...
            holder.mIvFolderCheck.setImageDrawable(createCheckIcon(colorTheme, R.drawable.bt_queding));
    ...
    public void setSelectFolder(BeanPhotoFolderInfo photoFolderInfo) {
        this.mSelectFolder = photoFolderInfo;
    }

    public BeanPhotoFolderInfo getSelectFolder() {
