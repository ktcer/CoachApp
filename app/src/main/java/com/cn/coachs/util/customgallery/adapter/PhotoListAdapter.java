 ...
 */
public class PhotoListAdapter extends CommonBaseAdapter<PhotoListAdapter.PhotoViewHolder, BeanPhotoInfo> {

    private Map<String, BeanPhotoInfo> mSelectList;
    private int mScreenWidth;
    private int mPickMode;

    public PhotoListAdapter(Context context, List<BeanPhotoInfo> list, Map<String, BeanPhotoInfo> selectList, int screenWidth, int pickMode) {
        super(context, list);
    ...
    public void onBindViewHolder(PhotoViewHolder holder, int position) {
        BeanPhotoInfo photoInfo = mList.get(position);
        ...
        holder.mIvThumb.setImageResource(R.drawable.default_pic);
        ...
        if (mPickMode == GalleryHelper.MULTIPLE_IMAGE) {
            ...
            holder.mIvCheck.setImageDrawable(createCheckIcon(Color.WHITE, R.drawable.bt_queding));
