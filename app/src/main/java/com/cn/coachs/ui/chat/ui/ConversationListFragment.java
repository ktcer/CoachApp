...
import com.cn.coachs.ui.chat.common.view.NetWarnBannerView;
...
import com.cn.coachs.ui.chat.ui.chatting.model.Conversation;
import com.cn.coachs.ui.chat.ui.contact.ECContacts;
import com.cn.coachs.ui.chat.ui.group.GroupNoticeActivity;
import com.cn.coachs.ui.chat.ui.group.GroupService;
...
public class ConversationListFragment extends TabFragment implements CCPListAdapter.OnListAdapterCallBackListener {
    ...
    private FloatingActionButton mFabSendAll;
        ...
        public void onItemClick(AdapterView<?> parent, View visew, int position,
            ...
            if (mAdapter != null) {
                ...
                if (tempECContacts != null) {
                    intent.putExtra(Constant.FANS_NAME, tempECContacts.getNickname());
                    intent.putExtra(Constant.fANS_IMAGEURL, tempECContacts.getImgUrl());
                    intent.putExtra(Constant.FANS_GENDER, tempECContacts.getSex());
                    intent.putExtra(Constant.FANS_AGE, tempECContacts.getAge());
                } else {
                    intent.putExtra(Constant.FANS_NAME, conversation.getUsername());
                    intent.putExtra(Constant.fANS_IMAGEURL, "");
                    intent.putExtra(Constant.FANS_GENDER, "-");
                    intent.putExtra(Constant.FANS_AGE, "0");
                }
                intent.putExtra(Constant.FAN_SESSIONID, conversation.getSessionId());
                startActivity(intent);
            }
        }
    };
    ...
    private void initView() {
        ...
        mFabSendAll = (FloatingActionButton) findViewById(R.id.fab_sendall);
        mFabSendAll.attachToListView(mListView);
        mFabSendAll.setVisibility(View.GONE);
        mFabSendAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //群发消息
            }
