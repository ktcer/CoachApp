 ...
 * @return
 */
public class DiaryItemRight extends LinearLayout {
    ...
    public DiaryItemRight(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        this.context = context;
        LayoutInflater.from(context).inflate(R.layout.listitem_historydiary_right, this, true);
        ...
        linearlayout = (LinearLayout) findViewById(R.id.right_top_layout);
...
//		if(!flag)
//			linearlayout.setBackgroundColor(context.getResources().getColor(android.R.color.darker_gray));
