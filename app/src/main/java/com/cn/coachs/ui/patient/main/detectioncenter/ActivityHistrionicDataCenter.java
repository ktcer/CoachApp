...
import com.cn.coachs.util.UtilsDate;
...
public class ActivityHistrionicDataCenter extends ActivityBasic {
    ...
    private List<BeanHistoricDetectionList> HBDList = new ArrayList<BeanHistoricDetectionList>();
    ...
    public class AdapterHistoryData extends BaseAdapter {
        private List<BeanHistoricDetectionList> plist;
        ...
        public AdapterHistoryData(List<BeanHistoricDetectionList> plist,
                                  Context mContext) {
            this.plist = plist;
...
//					dataName=historicDection_TW.getString("dataName");
        ...
        protected void onPostExecute(String result) {
            ...
            hideProgressBar();
            Collections.sort(HBDList, new Comparator<BeanHistoricDetectionList>() {
                /**
                 *
                 * @param lhs
                 * @param rhs
                 ...
                 */
                @Override
                public int compare(BeanHistoricDetectionList lhs, BeanHistoricDetectionList rhs) {
