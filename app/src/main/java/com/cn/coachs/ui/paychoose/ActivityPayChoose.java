package com.cn.coachs.ui.paychoose;
...
public class ActivityPayChoose extends ActivityBasic {
    ...
    private void pay() {
        ...
        if (flag.equals("微信支付")) {
            ...
            Pays pays = new Pays(ActivityPayChoose.this, description, description, money, 1);//mHandler
            pays.check();
            pays.pay();

        } else if (flag.equals("银联支付")) {
            Toast.makeText(ActivityPayChoose.this, "银联支付暂时还没开通，嘿嘿", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        midTV.setText("支付");
        payTectView = (TextView) findViewById(R.id.go_pay);
        payTectView.setOnClickListener(this);
        payTectView.setVisibility(View.GONE);
...
//				Toast.makeText(MainActivity.this, rb.getText(), Toast.LENGTH_SHORT).show();
                ...
                PayRadioPurified rl = (PayRadioPurified) ActivityPayChoose.this.findViewById(radioButtonId);
...
//				Toast.makeText(ActivityPayChoose.this, rl.getTextTitle(), Toast.LENGTH_SHORT).show();
    ...
    private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String, String>> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(ActivityPayChoose.this, getString(R.string.app_tip), getString(R.string.getting_prepayid));
        }
