...
import com.cn.coachs.ui.chat.ui.chatting.base.EmojiconEditText;
import com.cn.coachs.ui.chat.ui.group.CreateGroupActivity;
...
public class EditConfigureActivity extends ECSuperActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String title = "";
        if (mSettingType == ActivityMsgSettings.CONFIG_TYPE_APPKEY) {
            title = getString(R.string.edit_appkey);
            mSettings = ECPreferenceSettings.SETTINGS_APPKEY;
        } else if (mSettingType == ActivityMsgSettings.CONFIG_TYPE_TOKEN) {
            title = getString(R.string.edit_token);
            mSettings = ECPreferenceSettings.SETTINGS_TOKEN;
        } else if (mSettingType == ActivityMsgSettings.CONFIG_TYPE_SERVERIP) {
