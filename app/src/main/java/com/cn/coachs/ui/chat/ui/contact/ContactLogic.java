...
import com.cn.coachs.ui.chat.common.utils.BitmapUtil;
import com.cn.coachs.ui.chat.common.utils.DemoUtils;
import com.cn.coachs.ui.chat.common.utils.DialNumberMap;
import com.cn.coachs.ui.chat.common.utils.ECPropertiesUtil;
import com.cn.coachs.ui.chat.common.utils.FileAccessor;
import com.cn.coachs.ui.chat.common.utils.LogUtil;
import com.cn.coachs.ui.chat.common.utils.ResourceHelper;
    ...
    public static ArrayList<ECContacts> sortContacts(ArrayList<ECContacts> beas) {
        ...
        Collections.sort(beas, new Comparator<ECContacts>() {
            ...
            public int compare(ECContacts lhs, ECContacts rhs) {
                ...
                if (lhs.getIsMaster() == 1 && rhs.getIsMaster() == 1)
                    return rhs.getRemainServeTime() - lhs.getRemainServeTime();
