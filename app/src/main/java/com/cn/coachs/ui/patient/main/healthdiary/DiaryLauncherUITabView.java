...
import com.cn.coachs.ui.chat.common.base.CCPTabView;
import com.cn.coachs.ui.chat.common.utils.DensityUtil;
 ...
 */
public class DiaryLauncherUITabView extends RelativeLayout implements View.OnClickListener {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            LogUtil.v(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class), "onMainTabClick");
            if (mListener != null) {
     ...
     * @param context
     */
    public DiaryLauncherUITabView(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public DiaryLauncherUITabView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        ...
        tabViewMain.tabView.setText(R.string.morning);
        ...
        tabViewSecond.tabView.setText(R.string.afternoon);
        ...
        tabViewContacts.tabView.setText(R.string.night);
    ...
    public void onClick(View v) {
        ...
        if ((mCurrentSlideIndex == intValue) && (intValue == TAB_VIEW_SECOND) && (System.currentTimeMillis() - mClickTime <= 300L)) {
            LogUtil.v(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class), "onMainTabDoubleClick");
        ...
        mClickTime = System.currentTimeMillis();
        mCurrentSlideIndex = intValue;
        LogUtil.v(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class), "on UITabView click, index " + intValue + ", but listener is " + mListener);
    }
    ...
    public final void updateMainTabUnread(int unreadCount) {
        LogUtil.d(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class), "updateMainTabUnread unread count " + unreadCount);
        if (unreadCount > 0) {
            if (unreadCount > 99) {
    ...
    public final void updateSecondTabUnread(int unreadCount) {
        LogUtil.d(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class), "updateSecondTabUnread unread count " + unreadCount);
        if (unreadCount > 0) {
            if (unreadCount > 99) {
    ...
    public final void updateContactsTabUnread(int unreadCount) {
        LogUtil.d(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class), "updateContactsTabUnread unread count " + unreadCount);
        if (unreadCount > 0) {
            if (unreadCount > 99) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        LogUtil.d(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class), "on layout, width " + (r - l));
        ...
        if (mIndicatorBitmap == null || mIndicatorBitmap.getWidth() != mTabViewBaseWidth) {
            ...
            LogUtil.d(LogUtil.getLogUtilsTag(DiaryLauncherUITabView.class),
