...
import com.cn.coachs.ui.chat.core.ContactsCache.InterfaceGetContactsListener;
import com.cn.coachs.ui.chat.storage.ContactSqlManager;
import com.cn.coachs.ui.chat.storage.GroupNoticeSqlManager;
...
import com.cn.coachs.ui.chat.ui.contact.MobileContactActivity;
import com.cn.coachs.ui.chat.ui.contact.MobileContactActivity.MobileContactFragment;
import com.cn.coachs.ui.chat.ui.group.GroupNoticeActivity;
 ...
 */
public class ActivityHealthAssist extends ActivityBasic implements View.OnClickListener, ConversationListFragment.OnUpdateMsgUnreadCountsListener, InterfaceGetContactsListener {
...
//    public HashMap<String,ECContacts> contacts = new HashMap<String, ECContacts>();
...
//    private OverflowAdapter.OverflowItem[] mItems = new OverflowAdapter.OverflowItem[3];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mLauncherUI != null) {
            LogUtil.i(LogUtil.getLogUtilsTag(ActivityHealthAssist.class), "finish last LauncherUI");
            mLauncherUI.finish();
        }
        mLauncherUI = this;
...
//    }
    ...
    public final BaseFragment getTabView(int tabIndex) {
        LogUtil.d(LogUtil.getLogUtilsTag(ActivityHealthAssist.class), "get tab index " + tabIndex);
        if (tabIndex < 0) {
            return null;
        }
...
//                break;
    ...
    public void ctrlViewTab(int index) {
        ...
        LogUtil.d(LogUtil.getLogUtilsTag(ActivityHealthAssist.class), "change tab to "
...
//        LogUtil.d(LogUtil.getLogUtilsTag(ActivityHealthAssist.class), " onKeyDown");
//
...
//        } catch (Exception e) {
//            LogUtil.e(LogUtil.getLogUtilsTag(ActivityHealthAssist.class), "dispatch key event catch exception " + e.getMessage());
//        }
//
//        return false;
//    }
    ...
    public void onResume() {
        LogUtil.i(LogUtil.getLogUtilsTag(ActivityHealthAssist.class), "onResume start");
        super.onResume();
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (contacts != null) {
            ...
            if (!TextUtils.isEmpty(mSession) && mSession.startsWith("g")) {
                ...
                chatIntent.putExtra(Constant.FANS_NAME, ecGroup.getName());
            } else {
                chatIntent.putExtra(ChattingActivity.RECIPIENTS, contacts.getContactid());
                chatIntent.putExtra(Constant.FANS_NAME, contacts.getNickname());
            }
...
//            controlPlusSubMenu();
//            if (position == 3) {
//                startActivity(new Intent(ActivityHealthAssist.this, ContactSelectListActivity.class));
//            } else if (position == 0) {
//                startActivity(new Intent(ActivityHealthAssist.this, CreateGroupActivity.class));
//            } else if (position == 1) {
//                startActivity(new Intent(ActivityHealthAssist.this, BaseSearch.class));
//            } else if (position == 2) {
//                startActivity(new Intent(ActivityHealthAssist.this, ActivityMsgSettings.class));
//            }
//        }
//
//    };
