...
public class LoginSettingActivity extends ECSuperActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mSettingServerIp.setOnClickListener(new OnConfigClickListener(ActivityMsgSettings.CONFIG_TYPE_SERVERIP));
        mSettingAppkey.setOnClickListener(new OnConfigClickListener(ActivityMsgSettings.CONFIG_TYPE_APPKEY));
        mSettingToken.setOnClickListener(new OnConfigClickListener(ActivityMsgSettings.CONFIG_TYPE_TOKEN));
        initConfigValue();
    }
