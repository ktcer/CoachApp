...
//		max = Bimp.max;
        ...
        photo_bt_del.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (listViews.size() == 1) {
//					ActivityRegisterInfo.photoInfoList.clear();
//					Bimp.bmp.clear();
//					Bimp.drr.clear();
//					Bimp.max = 0;
                    FileUtils.deleteDir();
...
//					FileUtils.delFile(ActivityRegisterInfo.photoInfoList.get(count).getPhotoPath());
//					ActivityRegisterInfo.photoInfoList.remove(count);
                    //					drr.remove(count);
//					del.add(newStr);
//					max--;
...
//		for (int i = 0; i < ActivityRegisterInfo.photoInfoList.size(); i++) {
//			initListViews(ActivityRegisterInfo.photoInfoList.get(i).getPhotoPath());//
//		}
