 ...
 */
package com.cn.coachs.ui.chat.ui.group;
...
import com.cn.coachs.ui.chat.storage.GroupMemberSqlManager;
...
import com.cn.coachs.ui.chat.ui.contact.MobileContactSelectActivity;
import com.cn.coachs.ui.chat.ui.settings.ActivityMsgSettings;
import com.cn.coachs.ui.chat.ui.settings.EditConfigureActivity;
...
public class GroupInfoActivity extends ECSuperActivity implements
    ...
    private void refeshGroupInfo() {
        ...
        if (isOwner()) {
            mNameItem.setOnClickListener(new OnItemClickListener(ActivityMsgSettings.CONFIG_TYPE_GROUP_NAME));
            mNoticeItem.setOnClickListener(new OnItemClickListener(ActivityMsgSettings.CONFIG_TYPE_GROUP_NOTICE));
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0x2a) {
            ...
            if (mEditMode == ActivityMsgSettings.CONFIG_TYPE_GROUP_NAME) {
