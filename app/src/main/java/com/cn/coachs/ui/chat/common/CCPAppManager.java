 ...
 */
package com.cn.coachs.ui.chat.common;
...
import com.cn.coachs.ui.chat.common.utils.MimeTypesTools;
import com.cn.coachs.ui.chat.core.ClientUser;
import com.cn.coachs.ui.chat.ui.ECSuperActivity;
import com.cn.coachs.ui.chat.ui.chatting.ImageGalleryActivity;
import com.cn.coachs.ui.chat.ui.chatting.ImageGralleryPagerActivity;
import com.cn.coachs.ui.chat.ui.chatting.ImageMsgInfoEntry;
import com.cn.coachs.ui.chat.ui.chatting.ViewImageInfo;
import com.cn.coachs.ui.chat.ui.chatting.view.ChatFooterPanel;
...
public class CCPAppManager {
    ...
    public static ClientUser getClientUser() {
        if (mClientUser != null) {
            Log.i("test", "mClientUser:" + mClientUser);
            return mClientUser;
        }
        String registAccount = getAutoRegistAccount();
        Log.i("test", "registAccount:" + registAccount);
        if (!TextUtils.isEmpty(registAccount)) {
            mClientUser = new ClientUser("");
            Log.i("test", "clientUser:" + mClientUser.from(registAccount));
            return mClientUser.from(registAccount);
        }
        //为了防止SDKCoreHelper中onInitialized获得的clientUser为null
