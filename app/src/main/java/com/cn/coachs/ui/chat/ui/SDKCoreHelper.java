...
//        if(clientUser == null){
//        	Toast.makeText(mContext, R.string.errormsg_server, Toast.LENGTH_SHORT).show();
//        	Log.i("test", "clientUser is null");
//        	return ;
//        }
//        Log.i("test", "clientUser!!!!"); 
    ...
    public void onConnectState(ECDevice.ECConnectState state, ECError error) {
        if (state == ECDevice.ECConnectState.CONNECT_FAILED && error.errorCode == SdkErrorCode.SDK_KICKED_OFF) {
            ...
            mContext.sendBroadcast(intent);
            if (ActivityHealthAssist.mLauncherUI != null) {
                ActivityHealthAssist.mLauncherUI.handlerKickOff(error.errorMsg);
            }
