...
import com.cn.coachs.coach.model.BeanCoachOrderDetail;
...
public class ActivityMyOrderInfo extends ActivityBasic {
    ...
    private TextView tvOrderPeople, tvPaytime;
...
//        });
        ...
        tvPaytime = (TextView) findViewById(R.id.pay_time);
    ...
    private class QueryOrderInfo extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (beanCoachOrderDetail != null) {
                tvOrderPeople.setText(beanCoachOrderDetail.getUserName());
                tvOrderTime.setText(beanCoachOrderDetail.getStartTime());
                tvPaytime.setText(beanCoachOrderDetail.getPayTime());
