...
//        mController.getConfig().setSsoHandler(new TencentWBSsoHandler());
        QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(context,
                "1105100060", "jyHR6YMBKvwYhLKV");//  "100424468", "c7394704798a158208a74ab60104f0ba"
...
//        mController.getConfig().setSsoHandler(renrenSsoHandler);
    ...
    private void addQQQZonePlatform() {
        String appId = "1105100060";
        String appKey = "jyHR6YMBKvwYhLKV";
    ...
    private void addWXPlatform() {
        ...
        String appId = "wx6c903b5396923247";
        String appSecret = "491709455fe713511e1b3fcd4d5334ce";
        // 添加微信平台
