...
public class Pays {
    ...
    public Pays(ActivityBasic act, String commodityName, String commodityDescribe,
                String commodityPrice, String orderNo, float price, int payKinds) {
        super();
        this.act = act;
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        Toast.makeText(act, "支付成功，请到单订单列表查看详情",
...
//						showProgressBar();
//						ConfirmExpectAsyncTask confirmExpectAsyncTask = new ConfirmExpectAsyncTask();
...
//						Toast.LENGTH_SHORT).show();
        ...
        private void payMyGold() {
            act.showProgressBar();
            AscyncPayGold ascypgTask = new AscyncPayGold(act, AdapterMyIntegral.gold + "") {
                ...
                protected void onPostExecute(BeanPayGold result) {
                    ...
                    if (result.getResult().equals("success")) {
                        ...
                        Toast.makeText(act, "失败" + result.getNowcoins(), 1000).show();
                    }
                }
        ...
        private void payTravel() {
            act.showProgressBar();
            AscyncPayDone apd = new AscyncPayDone(act, orderNo, price) {
...
//		private void call() {
//			int callResult = MakeCall.makecall(act, UtilsSharedData.getValueByKey(Constant.USER_ACCOUNT),
//					"40045635");
//			if (callResult != 0) {
//			    //重新登录
//				Toast.makeText(act, MakeCall.getReturnMeaning(callResult), 1000).show();
//			}
//			
//		};
    };
    ...
    public void pay() {
        ...
        // 订单
        String orderInfo = getOrderInfo(commodityName, commodityDescribe, allPrice);
